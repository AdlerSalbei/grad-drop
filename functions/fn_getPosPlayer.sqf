...
private _helperLeft = "" createVehicleLocal (_pos vectorAdd [1,0,0]);
private _helperMiddle = "" createVehicleLocal (_pos vectorAdd [1,0,0]);
private _helperRight = "" createVehicleLocal (_pos vectorAdd [1,0,0]);
...
private _slotLeft = [_plane, _areaArray] call XXX_fnc_sortUnits;
...
private _slotMiddle = [_plane, _areaArray] call XXX_fnc_sortUnits;
...
private _slotRight = [_plane, _areaArray] call XXX_fnc_sortUnits;
